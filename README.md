...
3. Use the `Authorize` button in the top-right corner of the FastAPI docs to log in with your credentials (use the email you registered with as the username and ignore the extra fields).
